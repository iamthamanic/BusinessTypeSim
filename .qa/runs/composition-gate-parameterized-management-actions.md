...
- HEAD_SHA: 3a462e149ac6bdfdbc0a32f75dd7cb82d803714f
- Date: 2026-09-13
- Verdict: CLEAR
...
| 2 consumers / crash | Same proposal idempotent on commit; edit before commit only | Commit uses confirmed proposal from client state; AI route does not mutate run | pass |
